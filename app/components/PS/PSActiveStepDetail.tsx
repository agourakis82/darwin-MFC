    ...
    <section className="overflow-hidden rounded-[32px] border shadow-[0_18px_48px_rgba(0,0,0,0.18)]" style={{ background: 'rgba(255,255,255,0.035)', borderColor: alert.border }}>
      ...
      <div className="space-y-5 px-5 py-5">
        <div>
          ...
          <h2 className="mt-2 text-[2rem] font-bold leading-tight tracking-[-0.04em] text-white md:text-[2.35rem]">{step.title}</h2>
          <p className="mt-3 max-w-3xl text-sm leading-relaxed text-slate-400 md:text-[15px]">{step.description}</p>
        </div>
        ...
        <div className="rounded-[28px] border border-white/8 bg-[#08111d]/82 p-4 md:p-5">
          ...
          {step.type === 'drug' && step.drugId && (
            <button
              ...
              className="inline-flex min-h-[56px] items-center justify-center gap-2 rounded-[22px] border border-amber-400/22 bg-amber-500/10 px-4 py-3.5 text-sm font-semibold text-amber-100 transition-all duration-150 ease-out hover:bg-amber-500/14"
            >
          ...
          {step.type === 'timer' && (
            <button
              type="button"
              onClick={onOpenTimer}
              className="inline-flex min-h-[56px] items-center justify-center gap-2 rounded-[22px] border border-rose-400/20 bg-rose-500/10 px-4 py-3.5 text-sm font-semibold text-rose-100 transition-all duration-150 ease-out hover:bg-rose-500/14"
            >
          ...
          {step.type === 'score' && step.scoreId && (
            <Link
              ...
              className="inline-flex min-h-[56px] items-center justify-center gap-2 rounded-[22px] border border-cyan-400/20 bg-cyan-400/10 px-4 py-3.5 text-sm font-semibold text-cyan-100 transition-all duration-150 ease-out hover:bg-cyan-400/14"
            >
        ...
        {step.type === 'decision' && step.options?.length ? (
          ...
          <button
            ...
            onClick={onAdvance}
            disabled={isLastStep}
            className="flex w-full items-center justify-center gap-2 rounded-[30px] px-4 py-4 text-sm font-bold transition-all duration-150 ease-out shadow-[0_18px_40px_rgba(0,0,0,0.16)]"
            style={isLastStep
