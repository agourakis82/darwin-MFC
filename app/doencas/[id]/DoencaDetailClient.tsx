  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="mt-12 grid md:grid-cols-3 gap-4">
        {doenca.medicamentos.length > 0 && (
          <Link href="/medicamentos" className="glass-subtle rounded-xl p-4 hover:shadow-lg transition-all group">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-semibold group-hover:text-blue-600">{doenca.medicamentos.length} Medicamentos</div>
        ...
        {doenca.protocolos.length > 0 && (
          <Link href="/protocolos" className="glass-subtle rounded-xl p-4 hover:shadow-lg transition-all group">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-semibold group-hover:text-purple-600">{doenca.protocolos.length} Protocolos</div>
        ...
        {doenca.calculadoras.length > 0 && (
          <Link href="/calculadoras" className="glass-subtle rounded-xl p-4 hover:shadow-lg transition-all group">
            <div className="flex items-center gap-3">
              <Calculator className="w-8 h-8 text-emerald-500" />
              <div>
                <div className="font-semibold group-hover:text-emerald-600">{doenca.calculadoras.length} Calculadoras</div>
