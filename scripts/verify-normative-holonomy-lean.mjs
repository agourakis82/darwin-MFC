...
const leanDir = resolve(repoRoot, 'docs/research/normative-holonomy/formal/lean4');
const theoremPath = resolve(leanDir, 'NormativeHolonomy.lean');
const auditPath = resolve(leanDir, 'NormativeHolonomyAudit.lean');
...
const audit = run('lake', ['env', 'lean', 'NormativeHolonomyAudit.lean']);
...
const expectedAxioms = {
  'Darwin.NormativeHolonomy.globalSectionIffHolonomyFixedPoint': [],
  'Darwin.NormativeHolonomy.oddFlipTransport_locallyCertified': ['propext'],
  'Darwin.NormativeHolonomy.oddFlipTransport_has_no_global_section': ['propext'],
  'Darwin.NormativeHolonomy.locallyCertifiedDoesNotImplyGlobalSection': ['propext'],
  'Darwin.NormativeHolonomy.noGlobalSectionForcesAbstention': [],
  'Darwin.NormativeHolonomy.seededNoGlobalSectionForcesAbstention': [],
  'Darwin.NormativeHolonomy.pathIndependentHasGlobalSection': ['Classical.choice'],
  'Darwin.NormativeHolonomy.HolonomyObstructionCertificate.noGlobalSection': [],
};
...
const result = {
  schema: 'darwin.normative-holonomy-lean-verification.v0.9',
  generatedAt,
  ...
  audit: {
    command: 'lake env lean NormativeHolonomyAudit.lean',
    exitCode: audit.status,
    observedAxioms,
    centralTheoremsAxiomFree: [
      'Darwin.NormativeHolonomy.globalSectionIffHolonomyFixedPoint',
      'Darwin.NormativeHolonomy.noGlobalSectionForcesAbstention',
      'Darwin.NormativeHolonomy.seededNoGlobalSectionForcesAbstention',
    ].every((name) => observedAxioms[name]?.length === 0),
    forbidden,
  },
