...
export const doencasInfecciosas: Doenca[] = [
  {
    ...
    gradeAssessments: {
      'fosfomicina-cistite': {
        ...
        rationale: 'Meta-analises de ECRs demonstram eficacia similar aos esquemas de 3-7 dias com outros antibioticos. Vantagem da dose unica para adesao.',
        strength: 'strong_for',
      },
      'nitrofurantoina-cistite': {
        grade: 'A',
        quality: 'high',
        primaryStudyType: 'RCT',
        rationale: 'ECRs de boa qualidade mostram eficacia de 90-95% na erradicacao bacteriana. Baixa resistencia bacteriana.',
        strength: 'strong_for',
      },
      'quinolona-reserva': {
        grade: 'B',
        quality: 'moderate',
        primaryStudyType: 'Guideline',
        rationale: 'Recomendacao baseada em preocupacao com resistencia bacteriana crescente. ECRs mostram eficacia mas diretrizes recomendam reservar.',
        limitations: ['Decisao baseada em ecologia mais que eficacia clinica'],
        strength: 'weak_against',
      },
      'urocultura-nao-complicada': {
        grade: 'C',
        quality: 'low',
        primaryStudyType: 'Cohort',
        rationale: 'Estudos observacionais mostram que tratamento empirico e eficaz na maioria dos casos de cistite nao complicada sem urocultura.',
        strength: 'weak_against',
      },
    },
  },
  {
    ...
    gradeAssessments: {
      'penicilina-gas': {
        ...
        quality: 'high',
        primaryStudyType: 'MetaAnalysis',
        rationale: 'Decadas de evidencia de alta qualidade suportam penicilina para erradicacao de GAS e prevencao de febre reumatica. Taxa de resistencia 0%.',
        strength: 'strong_for',
      },
      'centor-estratificacao': {
        grade: 'B',
        quality: 'moderate',
        primaryStudyType: 'Cohort',
        rationale: 'Estudos de validacao mostram boa capacidade de estratificacao de risco. VPP limitado para identificar GAS.',
        limitations: ['Sensibilidade limitada em adultos', 'Validacao variavel entre populacoes'],
        strength: 'strong_for',
      },
      'azitromicina-alternativa': {
        ...
        quality: 'moderate',
        primaryStudyType: 'RCT',
        rationale: 'ECRs mostram eficacia similar a penicilina em alergicos. Preocupacao com resistencia emergente de S. pyogenes.',
        limitations: ['Taxa de resistencia crescente em algumas regioes'],
        strength: 'weak_for',
      },
      'teste-rapido': {
        grade: 'B',
        quality: 'moderate',
        primaryStudyType: 'MetaAnalysis',
        rationale: 'Meta-analises mostram especificidade >95% mas sensibilidade variavel (70-90%). Cultura continua sendo padrao-ouro.',
        strength: 'weak_for',
      },
    },
  },
