...
export const doencasEndocrinas: Doenca[] = [
  {
    ...
    overallGradeLevel: 'A',
    gradeAssessments: {
      'levotiroxina-reposicao': {
        grade: 'A',
        quality: 'high',
        primaryStudyType: 'MetaAnalysis',
        rationale: 'Decadas de experiencia clinica e estudos confirmam levotiroxina como tratamento padrao. Normalizacao de TSH correlaciona com desfechos clinicos.',
        strength: 'strong_for',
      },
      'tsh-monitoramento': {
        grade: 'A',
        ...
        rationale: 'TSH e o biomarcador mais sensivel para monitoramento. Grandes coortes validam associacao com desfechos cardiovasculares e neurologicos.',
        strength: 'strong_for',
      },
      'tratar-subclinico-tsh-maior-10': {
        grade: 'B',
        quality: 'moderate',
        primaryStudyType: 'RCT',
        rationale: 'ECRs mostram beneficio em tratar TSH >10 mU/L. Beneficio menos claro entre 5-10 mU/L, especialmente em idosos.',
        limitations: ['Evidencia limitada em idosos >70 anos', 'Desfechos duros escassos'],
        strength: 'strong_for',
      },
      'meta-idosos': {
        grade: 'C',
        quality: 'low',
        primaryStudyType: 'Cohort',
        rationale: 'Estudos observacionais sugerem que TSH levemente elevado (4-6) pode ser normal em idosos. TRUST trial nao mostrou beneficio em tratar.',
        limitations: ['Falta de ECRs especificos', 'Heterogeneidade entre populacoes'],
