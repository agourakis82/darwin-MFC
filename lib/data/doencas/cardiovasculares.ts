...
export const doencasCardiovasculares: Doenca[] = [
  {
    ...
    gradeAssessments: {
      'ieca-mortalidade': {
        ...
        rationale: 'Multiplas meta-analises de ECRs demonstram reducao de mortalidade com IECA em ICFEr (CONSENSUS, SOLVD). NNT ~20 para prevenir 1 morte em 3 anos.',
        strength: 'strong_for',
      },
      'betabloqueador-mortalidade': {
        grade: 'A',
        quality: 'high',
        primaryStudyType: 'MetaAnalysis',
        rationale: 'ECRs de alta qualidade (COPERNICUS, MERIT-HF, CIBIS-II) mostram reducao de 30-35% na mortalidade com betabloqueadores em ICFEr estavel.',
        strength: 'strong_for',
      },
      'espironolactona-nyha-iii-iv': {
        grade: 'A',
        quality: 'high',
        primaryStudyType: 'RCT',
        rationale: 'RALES demonstrou reducao de 30% na mortalidade com espironolactona em IC classe III-IV. Evidencia forte para pacientes sintomaticos.',
        strength: 'strong_for',
      },
      'restricao-sodio': {
        grade: 'C',
        ...
        rationale: 'Evidencia baseada principalmente em estudos observacionais e consenso de especialistas. Falta de ECRs robustos.',
        limitations: ['Ausencia de ECRs de grande escala', 'Dificuldade de adesao em estudos'],
        strength: 'weak_for',
      },
    },
  },
  {
    ...
    gradeAssessments: {
      'anticoagulacao-avc': {
        ...
        quality: 'high',
        primaryStudyType: 'MetaAnalysis',
        rationale: 'Meta-analises robustas de ECRs (RE-LY, ROCKET-AF, ARISTOTLE, ENGAGE AF-TIMI 48) demonstram reducao de 60-70% no risco de AVC com anticoagulacao adequada.',
        strength: 'strong_for',
      },
      'doac-vs-varfarina': {
        grade: 'A',
        quality: 'high',
        primaryStudyType: 'MetaAnalysis',
        rationale: 'DOACs demonstram eficacia similar ou superior a varfarina com menor risco de sangramento intracraniano em meta-analises de ECRs.',
        strength: 'strong_for',
      },
      'controle-frequencia': {
        grade: 'B',
        quality: 'moderate',
        primaryStudyType: 'RCT',
        rationale: 'AFFIRM e RACE mostraram que controle de frequencia e tao eficaz quanto controle de ritmo na maioria dos pacientes. Alguma incerteza em subgrupos.',
        limitations: ['Heterogeneidade entre estudos', 'Populacao idosa predominante'],
        strength: 'strong_for',
      },
      'ablacao-sintomaticos': {
        grade: 'B',
        quality: 'moderate',
        primaryStudyType: 'RCT',
        rationale: 'ECRs (CABANA, CASTLE-AF) sugerem beneficio da ablacao em pacientes sintomaticos refratarios a medicamentos, especialmente com IC.',
        limitations: ['Qualidade de vida como desfecho primario em alguns estudos'],
        strength: 'weak_for',
      },
    },
  },
