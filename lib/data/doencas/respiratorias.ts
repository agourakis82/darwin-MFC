...
export const doencasRespiratorias: Doenca[] = [
  {
    ...
    gradeAssessments: {
      'cessacao-tabagismo': {
        grade: 'A',
        quality: 'high',
        primaryStudyType: 'MetaAnalysis',
        rationale: 'Lung Health Study e multiplos ECRs demonstram que cessacao do tabagismo e a unica intervencao que reduz declinio da funcao pulmonar e mortalidade.',
        strength: 'strong_for',
      },
      'lama-sintomas': {
        grade: 'A',
        quality: 'high',
        primaryStudyType: 'MetaAnalysis',
        rationale: 'Meta-analises de ECRs (UPLIFT, POET-COPD) demonstram melhora significativa nos sintomas e reducao de exacerbacoes com LAMA.',
        strength: 'strong_for',
      },
      'laba-lama-combinacao': {
        grade: 'A',
        quality: 'high',
        primaryStudyType: 'RCT',
        rationale: 'ECRs (SPARK, FLAME) mostram superioridade de LABA+LAMA sobre monoterapia para reducao de exacerbacoes em pacientes sintomaticos.',
        strength: 'strong_for',
      },
      'ci-eosinofilos': {
        grade: 'B',
        quality: 'moderate',
        primaryStudyType: 'RCT',
        rationale: 'Analises post-hoc e ECRs sugerem beneficio do CI em pacientes com eosinofilos >300. IMPACT e ETHOS confirmam beneficio neste subgrupo.',
        limitations: ['Evidencia emergente, ponto de corte de eosinofilos ainda em debate'],
        strength: 'weak_for',
      },
      'reabilitacao-pulmonar': {
        ...
        quality: 'high',
        primaryStudyType: 'MetaAnalysis',
        rationale: 'Cochrane review com multiplos ECRs demonstra melhora significativa na dispneia, capacidade de exercicio e qualidade de vida.',
        strength: 'strong_for',
      },
    },
  },
  {
    ...
    overallGradeLevel: 'B',
    gradeAssessments: {
      'amoxicilina-pac-leve': {
        grade: 'A',
        quality: 'high',
        primaryStudyType: 'MetaAnalysis',
        rationale: 'Meta-analises de ECRs suportam amoxicilina como primeira linha em PAC leve ambulatorial, com cobertura adequada de S. pneumoniae.',
        strength: 'strong_for',
      },
      'curb65-estratificacao': {
        grade: 'B',
        quality: 'moderate',
        primaryStudyType: 'Cohort',
        rationale: 'Estudos de validacao mostram boa capacidade de estratificar gravidade. Validado em populacoes diversas.',
        limitations: ['Performance variavel em idosos muito idosos'],
        strength: 'strong_for',
      },
      'duracao-5-7-dias': {
        grade: 'A',
        quality: 'high',
        primaryStudyType: 'MetaAnalysis',
        rationale: 'Meta-analises demonstram que 5-7 dias de tratamento sao tao eficazes quanto esquemas mais longos, com menor risco de resistencia.',
        strength: 'strong_for',
      },
      'procalcitonina-guiar-atb': {
        grade: 'B',
        quality: 'moderate',
        primaryStudyType: 'RCT',
        rationale: 'ECRs sugerem que procalcitonina pode reduzir duracao do antibiotico com seguranca, mas nao e universalmente recomendada.',
        limitations: ['Custo e disponibilidade limitam aplicacao pratica'],
        strength: 'weak_for',
      },
    },
  },
