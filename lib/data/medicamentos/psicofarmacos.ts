    ...
    pharmgkb: [
      {
        ...
        implications: ['Increased fluoxetine plasma levels', 'Prolonged half-life', 'Higher risk of side effects'],
        dosageRecommendations: ['Consider lower starting dose (10mg)', 'Longer titration intervals', 'Monitor for serotonergic side effects'],
      },
      {
        gene: 'CYP2D6',
        variant: '*1/*1xN, *2/*2xN',
        phenotype: 'ultra_rapid_metabolizer',
        implications: ['Reduced fluoxetine levels', 'May have decreased efficacy'],
        dosageRecommendations: ['Standard dosing, monitor clinical response', 'May need higher doses if inadequate response'],
      },
    ],
    ...
    pharmgkb: [
      {
        gene: 'CYP2C19',
        level: '1A',
        summary: 'Sertralina é metabolizada pelo CYP2C19, afetando níveis plasmáticos e resposta terapêutica',
        ...
        variants: [
          {
            ...
            frequency: { european: 0.38, african: 0.45, asian: 0.35, hispanic: 0.40, southAsian: 0.42 },
            implications: [
              'Metabolismo normal da sertralina',
              'Resposta terapêutica esperada com dose padrão',
            ],
            dosageRecommendation: {
              recommendation: 'Usar dose padrão de sertralina (50-200 mg/dia)',
          ...
          },
          {
            ...
            frequency: { european: 0.25, african: 0.18, asian: 0.32, hispanic: 0.28, southAsian: 0.30 },
            implications: [
              'Metabolismo reduzido da sertralina',
              'Níveis plasmáticos moderadamente elevados',
            ],
            dosageRecommendation: {
              recommendation: 'Iniciar com dose padrão, considerar ajuste se efeitos adversos',
              reasoning: 'Atividade enzimática intermediária pode aumentar exposição',
              strength: 'moderate',
          ...
          },
          {
            allele: '*2/*2',
            phenotype: 'poor_metabolizer',
            frequency: { european: 0.03, african: 0.02, asian: 0.14, hispanic: 0.04, southAsian: 0.09 },
            implications: [
              'Metabolismo deficiente da sertralina',
              'Níveis plasmáticos significativamente elevados',
              'Maior risco de efeitos adversos (náusea, insônia, agitação)',
            ],
            dosageRecommendation: {
              recommendation: 'Considerar redução de 50% da dose OU ISRS alternativo não metabolizado pelo CYP2C19',
              reasoning: 'Ausência de atividade enzimática resulta em acúmulo significativo',
              strength: 'strong',
              classification: 'CPIC Level A - Poor metabolizer',
            },
            alternatives: ['fluoxetina', 'paroxetina'],
          },
          {
            allele: '*1/*17',
            phenotype: 'increased_function',
            frequency: { european: 0.22, african: 0.25, asian: 0.04, hispanic: 0.18, southAsian: 0.12 },
            implications: [
              'Metabolismo acelerado da sertralina',
              'Níveis plasmáticos possivelmente reduzidos',
            ],
            dosageRecommendation: {
              recommendation: 'Usar dose padrão, monitorar resposta clínica',
              reasoning: 'Maior clearance pode reduzir eficácia em alguns pacientes',
              strength: 'moderate',
              classification: 'CPIC Level B - Rapid metabolizer',
            },
          },
          {
            allele: '*17/*17',
            phenotype: 'ultra_rapid_metabolizer',
            frequency: { european: 0.04, african: 0.06, asian: 0.01, hispanic: 0.03, southAsian: 0.02 },
            implications: [
              'Metabolismo muito acelerado da sertralina',
              'Risco de subdosagem e falha terapêutica',
            ],
            dosageRecommendation: {
              recommendation: 'Considerar aumento de dose ou ISRS alternativo',
              reasoning: 'Atividade enzimática muito elevada diminui concentrações plasmáticas eficazes',
              strength: 'moderate',
              classification: 'CPIC Level B - Ultra-rapid metabolizer',
            },
            alternatives: ['paroxetina'],
          },
        ],
      },
    ],
    ...
    pharmgkb: [
      {
        gene: 'CYP2D6',
        level: '1A',
        summary: 'CYP2D6 metaboliza amitriptilina a nortriptilina. Metabolizadores pobres acumulam ambos e necessitam redução de dose; ultrarrápidos podem falhar terapeuticamente.',
        guidelineUrl: 'https://cpicpgx.org/guidelines/guideline-for-tricyclic-antidepressants-and-cyp2d6-and-cyp2c19/',
        variants: [
          {
            allele: '*1/*1',
            phenotype: 'normal_metabolizer',
            frequency: { european: 0.40, african: 0.35, asian: 0.50, hispanic: 0.42, southAsian: 0.45 },
            implications: [
              'Metabolismo normal da amitriptilina',
              'Conversão adequada a nortriptilina',
            ],
            dosageRecommendation: {
              recommendation: 'Dose padrão conforme indicação clínica',
              reasoning: 'Atividade enzimática normal gera perfil farmacocinético esperado',
              strength: 'strong',
              classification: 'CPIC Level A - Normal metabolizer',
            },
          },
          {
            allele: '*1/*4',
            phenotype: 'intermediate_metabolizer',
            frequency: { european: 0.25, african: 0.10, asian: 0.05, hispanic: 0.18, southAsian: 0.08 },
            implications: [
              'Metabolismo moderadamente reduzido',
              'Níveis ligeiramente elevados de amitriptilina',
            ],
            dosageRecommendation: {
              recommendation: 'Considerar redução de 25% na dose',
              reasoning: 'Redução parcial de CYP2D6 eleva concentrações plasmáticas moderadamente',
              strength: 'moderate',
          ...
          },
          {
            allele: '*4/*4',
            phenotype: 'poor_metabolizer',
            frequency: { european: 0.07, african: 0.02, asian: 0.01, hispanic: 0.04, southAsian: 0.02 },
            implications: [
              'Acúmulo significativo de amitriptilina e nortriptilina',
              'Risco elevado de cardiotoxicidade (prolongamento QT)',
              'Efeitos anticolinérgicos aumentados',
            ],
            dosageRecommendation: {
              recommendation: 'Reduzir dose em 50% ou usar antidepressivo alternativo',
              reasoning: 'Ausência de atividade CYP2D6 causa acúmulo perigoso de tricíclicos',
              strength: 'strong',
              classification: 'CPIC Level A - Poor metabolizer',
            },
            alternatives: ['nortriptilina (com TDM)', 'sertralina', 'citalopram'],
          },
          {
            allele: '*1/*1xN',
            phenotype: 'ultra_rapid_metabolizer',
            frequency: { european: 0.05, african: 0.20, asian: 0.02, hispanic: 0.08, southAsian: 0.10 },
            implications: [
              'Conversão acelerada de amitriptilina a nortriptilina',
              'Redução da eficácia terapêutica',
              'Razão nortriptilina/amitriptilina aumentada',
            ],
            dosageRecommendation: {
              recommendation: 'Considerar aumento de dose ou antidepressivo alternativo não metabolizado por CYP2D6',
              reasoning: 'Metabolismo ultrarrápido reduz concentrações eficazes de amitriptilina',
              strength: 'moderate',
              classification: 'CPIC Level A - Ultra-rapid metabolizer',
            },
    ...
    pharmgkb: [
      {
        ...
        variant: '*4/*4, *4/*5, *5/*5',
        phenotype: 'poor_metabolizer',
        implications: ['Increased haloperidol plasma levels', 'Higher risk of extrapyramidal symptoms', 'Increased QT prolongation risk'],
        dosageRecommendations: ['Reduce dose by 50%', 'More frequent EPS monitoring', 'ECG monitoring for QTc', 'Consider alternative antipsychotic'],
      },
      {
        gene: 'CYP2D6',
        variant: '*1/*1xN, *2/*2xN',
        phenotype: 'ultra_rapid_metabolizer',
        implications: ['Reduced haloperidol levels', 'May have decreased efficacy'],
        dosageRecommendations: ['Standard dosing', 'Monitor clinical response', 'May need dose adjustment'],
      },
    ],
    calculadoras: [],
    citations: [{ refId: 'rename-2024' }],
    ...
    pharmgkb: [
      {
        ...
        variant: '*4/*4, *4/*5, *5/*5',
        phenotype: 'poor_metabolizer',
        implications: ['Increased risperidone + 9-OH risperidone levels', 'Higher active moiety concentration', 'Increased risk of EPS and hyperprolactinemia'],
        dosageRecommendations: ['Start with lower dose (0.5mg)', 'Slower titration', 'Monitor for EPS and prolactin symptoms'],
      },
      {
        gene: 'CYP2D6',
        variant: '*1/*1xN, *2/*2xN',
        phenotype: 'ultra_rapid_metabolizer',
        implications: ['Increased conversion to 9-OH risperidone', 'Similar total active moiety (parent + metabolite)', 'May have slightly different effect profile'],
