    ...
    pharmgkb: [
      {
        ...
        variant: '*2/*2, *3/*3',
        phenotype: 'poor_metabolizer',
        implications: ['Increased sertraline plasma levels', 'Higher AUC exposure', 'Slightly increased side effect risk'],
        dosageRecommendations: ['Standard dosing usually appropriate', 'Consider lower starting dose if side effects occur', 'Monitor closely'],
      },
      {
        gene: 'CYP2C19',
        variant: '*17/*17',
        phenotype: 'ultra_rapid_metabolizer',
        implications: ['Decreased sertraline levels', 'Potential reduced efficacy'],
        dosageRecommendations: ['Standard dosing, may need higher doses', 'Monitor clinical response'],
      },
    ],
    calculadoras: ['phq-9', 'gad-7'],
    citations: [{ refId: 'rename-2024' }],
    ...
    pharmgkb: [
      {
        ...
        variant: '*4/*4, *4/*5, *5/*5',
        phenotype: 'poor_metabolizer',
        implications: ['Increased amitriptyline and nortriptyline levels', 'Higher risk of cardiotoxicity (QT prolongation)', 'Increased anticholinergic effects'],
        dosageRecommendations: ['Reduce dose by 50%', 'Use TDM (therapeutic drug monitoring)', 'Consider alternative antidepressant', 'ECG monitoring recommended'],
      },
      {
        gene: 'CYP2D6',
        variant: '*1/*1xN, *2/*2xN',
        phenotype: 'ultra_rapid_metabolizer',
        implications: ['Decreased amitriptyline levels', 'Increased nortriptyline/amitriptyline ratio', 'Reduced efficacy possible'],
        dosageRecommendations: ['Standard dosing, monitor response', 'May need dose increase', 'Consider TDM'],
      },
      {
        gene: 'CYP2C19',
        variant: '*2/*2, *3/*3',
        phenotype: 'poor_metabolizer',
        implications: ['Increased amitriptyline levels', 'Decreased conversion to nortriptyline'],
        dosageRecommendations: ['Consider 25% dose reduction', 'Monitor for side effects', 'Use TDM'],
      },
    ],
    calculadoras: ['phq-9'],
    citations: [{ refId: 'rename-2024' }],
