...
export const medicamentosExpansaoSOTA: Medicamento[] = [
  ...
  // ============================================
  {
    ...
    apresentacoes: [
      ...
      { forma: 'suspensao', concentracao: '200mg/5mL', disponivelSUS: true }
    ],
  ...
  },
  {
    ...
    apresentacoes: [
      { forma: 'comprimido', concentracao: '500mg', disponivelSUS: true },
      { forma: 'suspensao', concentracao: '250mg/5mL', disponivelSUS: true }
    ],
  ...
  // ============================================
  {
    ...
    apresentacoes: [
      ...
      { forma: 'suspensao', concentracao: '50mg/5mL', disponivelSUS: true }
    ],
